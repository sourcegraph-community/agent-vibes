      ...
      <main className="main-content">
        ...
        <div className="content-container">
          ...
          <section id="updates" className="section">
            ...
            <div className="card">
              <p className="text-gray-400">
                📰 This section will show product updates from Miniflux RSS feeds.
                <br />
                Configure feeds for: Cursor changelog, GitHub Copilot updates, Amp
                releases, etc.
                <br />
                <a
                  href="/docs/miniflux-integration.md"
                  className="text-blue-400 hover:text-blue-300"
                >
                  Setup guide →
                </a>
          ...
          <section id="research" className="section">
            ...
            <div className="card">
              <p className="text-gray-400">
                📚 This section will show research papers from arXiv, Papers with Code,
                etc.
                <br />
                Summaries generated by Ollama + miniflux-summary-agent.
                <br />
                <a
                  href="https://github.com/trly/miniflux-summary-agent"
                  className="text-blue-400 hover:text-blue-300"
                  target="_blank"
                  rel="noopener"
                >
          ...
          <section id="perspectives" className="section">
            ...
            <div className="card">
              <p className="text-gray-400">
                ✍️ This section will show perspective pieces and blog posts from tech
                leaders.
                <br />
                Feeds: a16z, developer advocates, industry thought leaders.
              </p>
            </div>
          </section>
